### description: using M180‑1 (T2 vs. T1 DMP) as reference, 
#  - compute consistency ratios (directional and strict) against other missions; 
#  - plot Δβ distributions for each comparison in a 1×6 PDF layout. ###
...
message("step1_6_DMP_num_change_with_increasing_inflight_time_T2vs.T1.R", flag)
