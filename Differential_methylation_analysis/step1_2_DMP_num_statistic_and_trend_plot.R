...
for (exp in dataset_info) {
  ...
  df_DMP_T2_to_D10pro <- df_DMP_list[[paste0(exp$T2, " to ", exp$D10pro)]]
  df_DMP_D10pro_to_T3 <- df_DMP_list[[paste0(exp$D10pro, " to ", exp$T3)]]
  ...
  DMP_list_deltaBeta0.05 <- list(up_T1_to_T2 = rownames(df_DMP_T1_to_T2[df_DMP_T1_to_T2$change_deltaBeta0.05 == "up",]),
                                ...
                                up_T2_to_D10pro = rownames(df_DMP_T2_to_D10pro[df_DMP_T2_to_D10pro$change_deltaBeta0.05 == "up",]),
                                down_T2_to_D10pro = rownames(df_DMP_T2_to_D10pro[df_DMP_T2_to_D10pro$change_deltaBeta0.05 == "down",]),
					                      stable_T2_to_D10pro = rownames(df_DMP_T2_to_D10pro[df_DMP_T2_to_D10pro$change_deltaBeta0.05 == "stable",]),

                                up_D10pro_to_T3 = rownames(df_DMP_D10pro_to_T3[df_DMP_D10pro_to_T3$change_deltaBeta0.05 == "up",]),
                                down_D10pro_to_T3 = rownames(df_DMP_D10pro_to_T3[df_DMP_D10pro_to_T3$change_deltaBeta0.05 == "down",]),
					                      stable_D10pro_to_T3 = rownames(df_DMP_D10pro_to_T3[df_DMP_D10pro_to_T3$change_deltaBeta0.05 == "stable",])
                                )
